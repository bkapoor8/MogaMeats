  ...
  return (
    <section id="about" className={`${className} overflow-hidden`}>
      <div className='flex flex-col lg:flex-row'>
        <div className="w-full lg:w-1/2 h-64 lg:h-auto bg-[url('/assets/about.jpg')] bg-center bg-no-repeat bg-cover"></div>
        <div className="w-full lg:w-1/2 p-6 sm:p-12 lg:p-24">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Welcome to <span className="text-primary">Moga Meat Bar & Grill</span></h1>
